        ...
        <form onSubmit={handleSubmit}>
          ...
          <>
            ...
            >
              ...
              <br />
              This includes: <span aria-label={"exclamation mark"}>!</span>{" "}
          ...
          <>
            <label htmlFor="conform-password" className="login-field">
              ...
              <span
                className={
                  validConformPassword || !conformPassword ? "hide" : "invalid"
                }
              >
                <FontAwesomeIcon icon={faTimes} size={"1x"} />
              </span>
            ...
            <p
              ...
              className={
                conformPassword && conformPasswordFocus && !validConformPassword
                  ? "instructions"
                  : "offscreen"
              }
            >
